              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" id="form" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Masukkan NIP/NPP</label>
                      <input type="text" name="nrp" class="form-control" id="nrp" required minlength="8">
                      <div class="invalid-feedback">Masukkan NIP/NPP!</div>
                    </div>
                    <div class="col-12">
                            ...
                            $.ajax({
                              ...
                              success: function() {
                                Swal.fire({
                                  icon: 'success',
                                  title: 'Berhasil',
                                  text: 'Berhasil Registrasi Dosen, Silahkan Login',
